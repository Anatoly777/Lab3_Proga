...
public final class Expedition implements AbilityOfExpedition{
    ...
    public void addExperience(String e){
        ...
        System.out.println("Опыт " + e + " добавлен в экспедицию " + this.name_expedition);
    ...
    public void supply(String about){
        System.out.println(getName() + " пополнила " + about);
    }
